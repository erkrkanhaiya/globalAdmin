/**
 * Standalone Server for Crm Product
 * This allows the crm product to run independently on its own host/port
 * 
 * Usage:
 *   - Set PRODUCT_NAME=crm in .env
 *   - Set PORT=5006 (or any port)
 *   - Run: npm run start:crm
 */
...
import { swaggerSpec } from '@/config/swagger.crm.js'
import crmRoutes from '@/products/crm/routes/index.js'

const PRODUCT_SLUG = 'crm'
