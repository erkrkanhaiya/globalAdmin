...
import { loginApi } from '@/60yard/api/auth'
...
export default function LoginPage() {
  ...
  if (isAuthenticated) {
    return <Navigate to="/60yard/dashboard" replace />
  }
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token }); localStorage.setItem('selected_product', '60yard'); localStorage.setItem('selected_product_slug', '60yard')
      const dest = location.state?.from?.pathname || '/60yard/dashboard'
  ...
  return (
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to 60Yard</div>
      ...
      <div className="auth-right">
        <div className="hero">
          <h1>Welcome to 60Yard</h1>
          <p>Your premier platform for property management and real estate solutions.</p>
