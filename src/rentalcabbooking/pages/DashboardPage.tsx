import StatCard from '@/rentalcabbooking/components/dashboard/StatCard'
import SalesAnalytics from '@/rentalcabbooking/components/dashboard/SalesAnalytics'
import GoalsCard from '@/rentalcabbooking/components/dashboard/GoalsCard'
import TransactionsTable from '@/rentalcabbooking/components/dashboard/TransactionsTable'
