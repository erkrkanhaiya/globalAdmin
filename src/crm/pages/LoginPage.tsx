...
import { loginApi } from '@/crm/api/auth'
import { useAuthStore } from '@/crm/store/auth'
...
export default function LoginPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token })
      // Store product info
      localStorage.setItem('selected_product', 'crm')
      localStorage.setItem('selected_product_slug', 'crm')
      const dest = location.state?.from?.pathname || '/crm/dashboard'
    ...
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to CRM</div>
      ...
      <div className="auth-right">
        <div className="hero">
          ...
          <p>Manage your customer relationships and streamline your business operations.</p>
