...
import { loginApi } from '@/livenotes/api/auth'
...
export default function LoginPage() {
  ...
  if (isAuthenticated) {
    return <Navigate to="/livenotes/dashboard" replace />
  }
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token }); localStorage.setItem('selected_product', 'livenotes'); localStorage.setItem('selected_product_slug', 'livenotes')
      const dest = location.state?.from?.pathname || '/livenotes/dashboard'
  ...
  return (
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to LiveNotes</div>
      ...
      <div className="auth-right">
        <div className="hero">
          <h1>Welcome to LiveNotes</h1>
          <p>Capture, organize, and share your notes in real-time with seamless collaboration.</p>
