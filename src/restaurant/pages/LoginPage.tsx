...
import { loginApi } from '@/restaurant/api/auth'
...
export default function LoginPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token }); localStorage.setItem('selected_product', 'restaurant'); localStorage.setItem('selected_product_slug', 'restaurant')
      const dest = location.state?.from?.pathname || '/restaurant/dashboard'
    ...
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to Restaurant</div>
      ...
      <div className="auth-right">
        <div className="hero">
          ...
          <p>Manage your restaurant operations, orders, and customer experience seamlessly.</p>
