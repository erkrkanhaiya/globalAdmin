import StatCard from '@/restaurant/components/dashboard/StatCard'
import SalesAnalytics from '@/restaurant/components/dashboard/SalesAnalytics'
import GoalsCard from '@/restaurant/components/dashboard/GoalsCard'
import TransactionsTable from '@/restaurant/components/dashboard/TransactionsTable'
