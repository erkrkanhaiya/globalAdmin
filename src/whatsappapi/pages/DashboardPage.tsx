import StatCard from '@/whatsappapi/components/dashboard/StatCard'
import SalesAnalytics from '@/whatsappapi/components/dashboard/SalesAnalytics'
import GoalsCard from '@/whatsappapi/components/dashboard/GoalsCard'
import TransactionsTable from '@/whatsappapi/components/dashboard/TransactionsTable'
