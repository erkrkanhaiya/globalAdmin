...
import { loginApi } from '@/whatsappapi/api/auth'
import { useAuthStore } from '@/whatsappapi/store/auth'
...
export default function LoginPage() {
  ...
  if (isAuthenticated) {
    return <Navigate to="/whatsappapi/dashboard" replace />
  }
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token }); localStorage.setItem('selected_product', 'whatsappapi'); localStorage.setItem('selected_product_slug', 'whatsappapi')
      const dest = location.state?.from?.pathname || '/whatsappapi/dashboard'
    ...
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to WhatsApp API</div>
      ...
      <div className="auth-right">
        <div className="hero">
          ...
          <p>Integrate and manage WhatsApp messaging for your business communications.</p>
