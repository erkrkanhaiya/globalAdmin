...
import { loginApi } from '@/ecom/api/auth'
...
export default function LoginPage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      login({ user, token })
      // Store product info
      localStorage.setItem('selected_product', 'ecom')
      localStorage.setItem('selected_product_slug', 'ecom')
      const dest = location.state?.from?.pathname || '/ecom/dashboard'
    ...
    <div className="auth">
      <div className="auth-left">
        ...
        <div style={{ display:'grid', placeContent:'center' }}>
          <div className="auth-card">
            <div className="auth-title" style={{ color: '#FFFFFF', fontWeight: 600, fontSize: '24px' }}>Log in to Ecom</div>
      ...
      <div className="auth-right">
        <div className="hero">
          ...
          <p>Manage your e-commerce store, products, orders, and customer experience seamlessly.</p>
