import StatCard from '@/ecom/components/dashboard/StatCard'
import SalesAnalytics from '@/ecom/components/dashboard/SalesAnalytics'
import GoalsCard from '@/ecom/components/dashboard/GoalsCard'
import TransactionsTable from '@/ecom/components/dashboard/TransactionsTable'
